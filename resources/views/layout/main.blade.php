...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <title>Majiid | @yield('title') </title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/pekerja">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/tambahpekerja">tambahpekerja</a>
                    </li>
                    <li class="nav-item">
    ...
    <footer style="background-color:#0099ff; height:200px">
      <div class="row">
          <div class="col">
              majiid831
          </div>
